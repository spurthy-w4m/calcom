...
const publicEndpointConstructor = (constructUri, version = exports.ApiVersion.NEUTRAL) => ({
    constructUri,
    auth: "public",
    apiVersion: version,
});
const ENDPOINTS = {
    ...
    EXCHANGE_OAUTH_AUTH_TOKEN: publicEndpointConstructor(([clientId]) => `oauth/${clientId}/exchange`, exports.ApiVersion.V2),
    REFRESH_OAUTH_TOKEN: publicEndpointConstructor(([clientId]) => `oauth/${clientId}/refresh`, exports.ApiVersion.V2),
    CREATE_EVENT_TYPE: {
...
const getEndpointData = (endpoint, params) => {
    ...
    if (typeof endpointData.constructUri === "function") {
        ...
        if (isParamsRecord(params)) {
            ...
            // @ts-ignore
            constructedUri = endpointData.constructUri(params);
        }
